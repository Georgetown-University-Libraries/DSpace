...
public final class DSpaceWebappServletFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        //try {
            ...
            log.error("TBTB Before DSpaceWebappServletFilter.doFilter() "+ hreq.getPathTranslated() + " " +hreq.getHeader("mail"), new Exception());
            ...
            try {
                ...
                log.error("TBTB After DSpaceWebappServletFilter.doFilter() "+ hreq.getPathTranslated() + " " +hreq.getHeader("mail"), new Exception());
